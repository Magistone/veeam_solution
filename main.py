...
parser.add_argument('period', help='How often to perform synchronization in seconds', type=int)
...
daemon.runSynchronization(args.in_folder, args.out_folder, args.period, logfile)